...
def parse_args():
    ...
    # Data parameters that depend on the chosen test data
    ...
    parser.add_argument('--nonpy', action='store_true', help='Disable npy option')

    # Parse initial arguments
    args = parser.parse_args()

    # Use parsed arguments to set other dependent variables
    TEST_DATA = DATASET_NAMES[args.choose_test_data]  # max 8
    TRAIN_DATA = DATASET_NAMES[args.choose_test_data]
    ...
    args.test_img_height = test_inf['img_height']
...
def main(args):
    ...
    if args.is_testing:
        ...
        output_dir = os.path.join(args.res_dir, args.train_data+"2"+ args.test_data, os.path.splitext(args.checkpoint_data)[0])
